...
- **Silent assumptions about undefined rules.** The exercise intentionally leaves some business rules undefined (hold duration, premium pricing, wheelchair-as-companion). Weaker students will guess silently; stronger students will document assumptions. If you see a design decision that seems to come from nowhere, ask: "Where is this rule defined? If it's not in the exercise, state it as an assumption."
